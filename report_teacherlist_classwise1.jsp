...
<title>Teacher List(Class wise)</title>
<style>
body {
...
try  {
            ...
            PreparedStatement st=connect.prepareStatement("select teacher_assignment_master.teacher_id,teacher_master.teacher_name from teacher_master,teacher_assignment_master where teacher_master.teacher_id=teacher_assignment_master.teacher_id and class_id=? and division_id=?");
            ...
            while (result.next()) {
           	...
           	int teacher_id = result.getInt(1);
               String teacher_name = result.getString(2);
               out.println("<tr>");
               out.println("<td>");
